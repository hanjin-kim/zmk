...
size_t zmk_physical_layouts_get_list(struct zmk_physical_layout const ***phys_layouts);

int zmk_physical_layouts_select(const struct zmk_physical_layout *phys_layout);